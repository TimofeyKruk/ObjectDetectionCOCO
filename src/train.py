...
if __name__ == '__main__':
    ...
    parser.add_argument("--saveName", help="Name how to save model weights file", default="SavedModelWeights2")
    parser.add_argument("--dataset_path", help="PATH to dataset location",
                        default="//media//cuda//HDD//Internship//Kruk//COCO//")
    parser.add_argument("--tensorboard", help="Name how to save tensorboard logs", default="runs//yolov2_training2")
